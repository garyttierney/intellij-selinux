...
import com.codingmates.intellij.selinux.cil.lang.core.stubs.types.CilBlockStubElementType;
import com.codingmates.intellij.selinux.cil.lang.core.stubs.types.CilMacroDeclarationStubElementType;
import com.codingmates.intellij.selinux.cil.lang.core.stubs.types.CilNameDeclarationStubElementType;
import com.codingmates.intellij.selinux.cil.lang.core.stubs.types.CilNamedListDeclarationStubElementType;
...
public final class CilTopLevelElementTypeMap {
     ...
     */
    public static final IElementType CATEGORYALIASACTUAL_STATEMENT = nameAssociation(
            "categoryaliasactual",
     ...
     */
    public static final IElementType IN_STATEMENT = new CilStatementElementType("in",
            CilStatementParseHint.NAMED_CONTAINER, CilInNamespaceImpl::new);
    /**
    ...
    public static final IElementType ROLEALLOW_STATEMENT = nameAssociation("roleallow",
            ROLE_SET_DECLARATIONS, ROLE_SET_DECLARATIONS);
    ...
    public static final IElementType ROLETYPE_STATEMENT = nameAssociation("roletype",
            ROLE_SET_DECLARATIONS, TYPE_DECLARATIONS);
    /**
     ...
     */
    //@todo name association expressions
    public static final IElementType SENSITIVITYCATEGORY_STATEMENT = nameAssociation(
            "sensitivitycategory",
            SENSITIVITY_DECLARATIONS, CATEGORY_DECLARATIONS);
    /**
     ...
     */
    public static final IElementType SENSITIVITYALIASACTUAL_STATEMENT = nameAssociation(
            "sensitivityaliasactual",
            type -> type == SENSITIVITYALIAS_DECLARATION, SENSITIVITY_REFERENCE);
    /**
    ...
    public static final IElementType TYPEALIASACTUAL_STATEMENT = nameAssociation("typealiasactual",
            type -> type == TYPEALIAS_DECLARATION, type -> type == TYPE_DECLARATION);
    /**
    ...
    private static IElementType nameAssociation(String keyword, CilReferenceRole sourceRole,
                                                CilReferenceRole targetRole) {
        return new CilNameAssociationElementType(keyword, CilStatementParseHint.NAME_ASSOCIATION,
                CilNameAssociationImpl::new, sourceRole, targetRole);
    }
    ...
    @NotNull
    private static IElementType nameOrdering(String sensitivityorder, CilReferenceRole role) {
    ...
    private void appendClassAndPermissionElements(
        ...
        append(builder, CLASSMAP_DECLARATION);
        append(builder, CLASSMAPPING_STATEMENT);
        append(builder, CLASSORDER_STATEMENT);
        append(builder, CLASSPERMISSION_DECLARATION);
        append(builder, CLASSPERMISSIONSET_STATEMENT);
    ...
    private void appendConditionalElements(
        ...
        append(builder, TUNABLE_DECLARATION);
    ...
    private void appendContainerElements(
        ...
        append(builder, BLOCK_DECLARATION);
        append(builder, IN_STATEMENT);
    ...
    private void appendInitialSidElements(
        ...
        append(builder, SIDCONTEXT_STATEMENT);
    ...
    private void appendMultiLevelSecurityElements(
        ...
        append(builder, CATEGORYALIASACTUAL_STATEMENT);
        append(builder, CATEGORYORDER_STATEMENT);
        append(builder, LEVEL_DECLARATION);
        append(builder, LEVELRANGE_DECLARATION);
        append(builder, SENSITIVITY_DECLARATION);
        append(builder, SENSITIVITYALIAS_DECLARATION);
        append(builder, SENSITIVITYALIASACTUAL_STATEMENT);
        append(builder, SENSITIVITYCATEGORY_STATEMENT);
        append(builder, SENSITIVITYORDER_STATEMENT);
//        add("categoryset", CilStatementKind.NAMED_SET_MODIFIER, SYM_SET_MODIFIER);
    ...
    private void appendRoleElements(ImmutableMap.Builder<String, CilTopLevelElementType> builder) {
        ...
        append(builder, ROLEATTRIBUTESET_STATEMENT);
        append(builder, ROLEBOUNDS_STATEMENT);
        append(builder, ROLETRANSITION_STATEMENT);
    ...
    private void appendTypeElements(ImmutableMap.Builder<String, CilTopLevelElementType> builder) {
        ...
        append(builder, TYPEATTRIBUTE_DECLARATION);
        append(builder, TYPEATTRIBUTESET_STATEMENT);
        append(builder, TYPEBOUNDS_STATEMENT);
        append(builder, TYPECHANGE_STATEMENT);
        append(builder, TYPEMEMBER_STATEMENT);
        append(builder, TYPEPERMISSIVE_STATEMENT);
    ...
    private void appendTypeEnforcementRuleElements(
        ...
        append(builder, DONTAUDIT_STATEMENT);
